...
import { AdUnitPushdown } from '../components/Ad/units/AdUnitPushdown';
import { ProviderNewsletter } from '../components/NewsLetterPage/useContextNewsletter';
import '../styles/fonts/BarlowCondensed/index.scss';
import '../styles/fonts/ProximaNova/index.scss';
import '../styles/fonts/Merriweather/index.scss';
import '../styles/fonts/BarlowSemiCondensed/index.scss';
import '../styles/fonts/Inter/index.scss';
import '../styles/fonts/OpenSans/index.scss';
...
const App: FunctionComponent<AppProps<PageProps>> = ({
  ...
  //  variable to refere block stylying which missing on local and dev
  ...
  return (
    <ProviderTree providers={providers}>
      ...
      <Script async defer strategy="lazyOnload" src="//cdn.cxense.com/cx.js" />
      <Script
        async
        defer
        strategy="lazyOnload"
        src="//cdn.cxense.com/cx.cce.js"
      />
      <Script
        async
        defer
